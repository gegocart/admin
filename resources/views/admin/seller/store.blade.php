		  		  	...
		  		  	<table class="w-full">
		  		  		<thead>
		  		  			<tr>
		  		  				<!-- <th width="5%"></th> -->
		  		  				<th width="5%">ID</th>
		  		  				<th width="80%">{{trans('sellerdetail.store')}}</th>
		  		  				<th width="5%">{{trans('sellerdetail.status')}}</th>
		  		  				<th width="10%">{{trans('sellerdetail.actions')}}</th>
		  		  			</tr>
		  		  		</thead>
		  		  		<tbody>
		  		  		@foreach($stores as $store)
		  		  			<tr>
		  		  				...
		  		  				<a href="{{url('admin/store/profile/'.$store->slug)}}">
		  		  				    <p class="text-xs text-orange font-semibold">{{$store->name}}
		  		  					</p>
                                  </a>
		  		  				</td>
...
<li class="mx-1">
	<a class="del"  rel="{{url('/admin/seller/'.$store->id.'/del_store')}}">
...
function change()
{
	...
	window.location.href="{{url('/admin/seller/'.$user->id.'/store?sort_by=')}}"+$sort_by+"&paginate="+$paginate+"&search="+$search;
}
