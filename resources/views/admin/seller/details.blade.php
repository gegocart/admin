...
@include('layouts.admin.error')
		...
		<!-- start -->
          ...
          @if($preuser->id!="")
		    	<a href="{{url('/admin/seller/'.$preuser->id.'/details')}}" class="rounded-full p-2 arrow_icon border border-transparent">
		 ...
		 @if($nextuser->id!="")
		    <a href="{{url('/admin/seller/'.$nextuser->id.'/details')}}" class="rounded-full p-2 arrow_icon border border-transparent">
		 ...
		 @endif
		   		...
		   		<div class="flex flex-col lg:flex-row">
		   			...
		   			<ul class="list-reset leading-loose px-1 lg:px-5 py-2 lg:py-0">
		   				<li>{{trans('sellerdetail.firstname')}} : {{$user->defaultAddress->firstname}}</li>
		   				<li>{{trans('sellerdetail.lastname')}} : {{$user->defaultAddress->lastname}}</li>
		   			...
		   			<ul class="list-reset leading-loose px-1 lg:px-5 py-2 lg:py-0">
		   			<li>{{trans('sellerdetail.country')}} : {{$user->defaultAddress->country->name}}</li>
		   			<li>{{trans('sellerdetail.mobile')}} : {{$user->defaultAddress->mobileno}}</li>	
		   			</ul>
		   		...
		   		<div id="more-option" class="hidden bg-white shadow rounded px-2 py-1 absolute border custom_border right-0 w-48">
		   			<ul class="list-reset text-sm leading-loose">
		   				<li><a href="{{url('/admin/seller/'.$user->id.'/sendmail')}}">{{trans('sellerdetail.sendmail')}}</a></li>
		   				<li><a href="#">
		   				...
		   				<li><a id="reset"  rel="{{url('/admin/seller/resetpassword')}}">{{trans('sellerdetail.resetpassword')}}</a></li>
		   				<li><a href="{{url('/admin/seller/'.$user->id.'/edit')}}">{{trans('sellerdetail.edituser')}}</a></li>
		   				<!-- <li><a href="#">
