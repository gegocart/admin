...
<div class="">
        ...
        <h2 class="text-base text-gray-700 font-semibold py-2">{{trans('setting.editsetting')}}</h2>
   ...
   <div class="py-4">
                ...
                <div class="  flex flex-col px-4">
                    ...
                    <span class="text-sm">{{trans('setting.key')}}</span>
                       ...
                       <input name="key"  value="{{ old('key',optional($setting)->key) }}" type="text" class="form-control w-full py-2 px-2 border text-sm"> 
 ...
 <div class="py-4">
                ...
                <div class="  flex flex-col px-4">
                    ...
                    <span class="text-sm">{{trans('setting.name')}}</span>
                       ...
                       <input name="name"  value="{{ old('name',optional($setting)->name) }}" type="text" class="form-control w-full py-2 px-2 border text-sm"> 
  ...
  <div class="py-4">
                ...
                <div class="  flex flex-col px-4">
                    ...
                    <span class="text-sm">{{trans('setting.description')}}</span>
                       ...
                       <textarea name="description" class="form-control w-full py-2 px-2 border text-sm" >{{ old('description',optional($setting)->description) }} 
                       </textarea>
   ...
   <div class="py-4">
                ...
                <div class="  flex flex-col px-4">
                    ...
                    <span class="text-sm">{{trans('setting.value')}}</span>
                       ...
                       <input name="value"  value="{{ old('value',optional($setting)->value) }}" type="text" class="form-control w-full py-2 px-2 border text-sm"> 
 ...
 <div class="py-4 px-4">
                    ...
                    <div class="flex my-2">
                    <input class="self-center m-2" type="radio" name="status" value="1" @if($setting->status=="1")checked
                    @endif >
                    <h4>{{trans('setting.active')}}</h4>
                    <input class="self-center mx-2" type="radio" name="status" value="0" @if($setting->status=="0")checked
                    @endif>
