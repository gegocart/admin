...
@include('admin.buyer.success')
	...
	@foreach($addresses as $address)
 	...
 	<li>
			 <a href="{{url('/admin/buyer/'.$userid.'/address/'.$address->id.'/edit')}}">
...
<li>
	...
	<a  class="del"  rel="{{url('/admin/buyer/address/'.$address->id.'/delete')}}">
...
function change()
{
    ...
    window.location.href="{{url('/admin/buyer/'.$userid.'/addresses?sort_by=')}}"+$sort_by+"&paginate="+$paginate+"&search="+$search;
}
