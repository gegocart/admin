                  ...
                  <!-- filter -->
		  		  <div class="seller_table bg-white overflow-y-auto">
		  		  	<table class="w-full">
                          ...
                          <td class="px-3 py-3">
                      	<form method="post" action="{{url('/admin/buyer/reviews/update')}}" accept-charset="UTF-8">
                      		@csrf
...
<li class="mx-1">
	<a class="del"  rel="{{url('/admin/buyer/'.$ratingReview->id.'/del_review')}}">
...
function change()
{
	...
	window.location.href="{{url('/admin/buyer/'.$user->id.'/reviews?sort_by=')}}"+$sort_by+"&paginate="+$paginate+"&search="+$search;
}
