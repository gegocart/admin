...
<div class="">
        ...
        <h2 class="text-base text-gray-700 font-semibold py-2">{{trans('adduser.addbuyerform')}}</h2>
 ...
 <div class="pt-3 px-4">
                    <button class="focus:outline-none bg_orange text-white text-sm px-8 py-2 rounded-full custom_shadow login_btn">{{trans('adduser.submit')}}</button>
